...
local function updateQuotaNr(unitDefID, count)
	...
	if WG.Quotas then
		...
		quotas[activeBuilderID] = quotas[activeBuilderID] or {}
		quotas[activeBuilderID][unitDefID] = quotas[activeBuilderID][unitDefID] or 0
		quotas[activeBuilderID][unitDefID] = math.max(quotas[activeBuilderID][unitDefID] + (count or 0), 0)
		WG.Quotas.update(quotas)
		cellRect.opts.quotanr = quotas[unitDefID]
	end
	redraw = true
end
...
function widget:Initialize()
	...
	WG["gridmenu"].getActiveBuilderID = function()
