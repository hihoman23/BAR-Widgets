...
... (301 lines left)
Collapse
unit_auto_group_preset.lua
11 KB
hihoman23
OP
 — Today at 7:32 AM
Rename the file to unit_auto_group.lua so that it overwrites the existing auto groups widget
﻿
local versionNum = "5.00"
...
function widget:UnitFinished(unitID, unitDefID, unitTeam)
	...
	if
		builtInFrame
		or immediate
		or groupableBuildings[unitDefID]
		or (builtInPlace[unitID] and #Spring.GetCommandQueue(unitID, 1) == 0)
	then
